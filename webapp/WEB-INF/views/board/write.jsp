...
<meta name="viewport" id="viewport" content="">
	...
	<link rel="stylesheet" type="text/css" href="/example/assets/css/Base.css">
<link rel="stylesheet" type="text/css" href="/example/assets/css/Layout.css">
<link rel="stylesheet" type="text/css" href="/example/assets/css/Content.css">
<link rel="stylesheet" type="text/css" href="/example/assets/css/Common.css">
<link rel="stylesheet" type="text/css" href="/example/assets/css/UI_Style.css"><script type="text/javascript" src="/JS/jquery-1.10.2.js"></script>
...
<![endif]-->
	...
	<link rel="stylesheet" type="text/css" href="/example/assets/css/Common_CSS_Detail_720_1709.css" >
	<link rel="stylesheet" type="text/css" href="/example/assets/css/Common_CSS_Detail_720plus_1709.css" >
	...
	<a href="http://bitacademy.com/Support/Support_cacaoView.asp" target="_blank"><img src="/Images/Common/KakaoTalk4SNB_1704.png" style="width:100%; "/></a>
				...
				<div id="Content">
					...
					<section class="section">
						<form name="FrmWrite" method="post" action="/example/write" onsubmit="return check_submit(this);">
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" name="name" class="form" value="" style="width:98%">
											</td>
										</tr>
										<tr>
